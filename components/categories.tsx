...
const categories: Category[] = [
  {
    ...
    subtitle: "экскурсии",
    count: 3,
    image: "/images/Обзороное%20Комбо/photo_2025-09-21%2017.18.54.jpeg",
  ...
  },
  {
    ...
    subtitle: "Абхазию",
    count: 2,
    image: "/images/ГОСТЕПРИИМНАЯ%20АБХАЗИЯ/photo_2025-09-21%2018.12.38.jpeg",
  ...
  },
  {
    ...
    subtitle: "туры",
    count: 4,
    image: "/images/Джиппинг%20в%20Абхазию/photo_2025-09-21%2018.26.31.jpeg",
  ...
  },
  {
    ...
    subtitle: "водопады",
    count: 3,
    image: "/images/Тур%20Ущелье%20ведьм/photo_2025-09-23%2014.10.08.jpeg",
  ...
  },
  {
    ...
    subtitle: "семьи",
    count: 2,
    image: "/images/Золотое%20кольцо%20абхазии/photo_2025-09-21%2018.00.24.jpeg",
  ...
  },
  {
    ...
    subtitle: "маршруты",
    count: 1,
    image: "/images/Бигфут%20Квадры/photo_2025-09-23%2014.04.30.jpeg",
...
export function Categories() {
  ...
  return (
    <section className="section overflow-hidden">
      ...
      <div className="flex gap-4 overflow-x-auto no-scrollbar px-4 sm:px-[max(1.25rem,calc((100vw-1400px)/2+1.25rem))] pb-4 snap-x snap-mandatory lg:grid lg:grid-cols-3 lg:overflow-visible lg:max-w-[1400px] lg:mx-auto lg:px-[4rem] xl:px-[5rem]"
      ...
      >
        {categories.map((cat, i) => (
          <motion.div
            ...
            className="flex-shrink-0 snap-start lg:flex-shrink-[1]"
          >
